...
public class MVCHelper<DATA> {
	private com.shizhefei.mvc.IDataAdapter<DATA> dataAdapter;
	private com.shizhefei.mvc.IRefreshView refreshView;
	private com.shizhefei.mvc.IDataSource<DATA> dataSource;
	...
	public static com.shizhefei.mvc.ILoadViewFactory loadViewFactory = new DefaultLoadViewFactory();

	public MVCHelper(com.shizhefei.mvc.IRefreshView refreshView) {
		this(refreshView, loadViewFactory.madeLoadView(), loadViewFactory.madeLoadMoreView());
	}

	public MVCHelper(com.shizhefei.mvc.IRefreshView refreshView, ILoadView loadView) {
		this(refreshView, loadView, null);
	}

	public MVCHelper(com.shizhefei.mvc.IRefreshView refreshView, ILoadView loadView, ILoadMoreView loadMoreView) {
		super();
	 ...
	 * @param fractory
	 */
	public static void setLoadViewFractory(com.shizhefei.mvc.ILoadViewFactory fractory) {
	 ...
	 * @param dataSource
	 */
	public void setDataSource(com.shizhefei.mvc.IDataSource<DATA> dataSource) {
	...
	public void setAdapter(com.shizhefei.mvc.IDataAdapter<DATA> adapter) {
	 ...
	 */
	public void setOnStateChangeListener(com.shizhefei.mvc.OnStateChangeListener<DATA> onStateChangeListener) {
	 ...
	 */
	public void setOnStateChangeListener(com.shizhefei.mvc.OnRefreshStateChangeListener<DATA> onRefreshStateChangeListener) {
	 ...
	 */
	public void setOnStateChangeListener(com.shizhefei.mvc.OnLoadMoreStateChangeListener<DATA> onLoadMoreStateChangeListener) {
	...
	public com.shizhefei.mvc.IDataAdapter<DATA> getAdapter() {
		return dataAdapter;
	}

	public com.shizhefei.mvc.IDataSource<DATA> getDataSource() {
		return dataSource;
	}
	...
	protected com.shizhefei.mvc.IRefreshView getRefreshView() {
		return refreshView;
	}
	 ...
	 * @param <DATA>
	 */
	private static class MOnStateChangeListener<DATA> implements com.shizhefei.mvc.OnStateChangeListener<DATA> {
		private com.shizhefei.mvc.OnStateChangeListener<DATA> onStateChangeListener;
		private com.shizhefei.mvc.OnRefreshStateChangeListener<DATA> onRefreshStateChangeListener;
		private com.shizhefei.mvc.OnLoadMoreStateChangeListener<DATA> onLoadMoreStateChangeListener;

		public void setOnStateChangeListener(com.shizhefei.mvc.OnStateChangeListener<DATA> onStateChangeListener) {
			this.onStateChangeListener = onStateChangeListener;
		}

		public void setOnRefreshStateChangeListener(com.shizhefei.mvc.OnRefreshStateChangeListener<DATA> onRefreshStateChangeListener) {
			this.onRefreshStateChangeListener = onRefreshStateChangeListener;
		}

		public void setOnLoadMoreStateChangeListener(com.shizhefei.mvc.OnLoadMoreStateChangeListener<DATA> onLoadMoreStateChangeListener) {
			this.onLoadMoreStateChangeListener = onLoadMoreStateChangeListener;
		}

		@Override
		public void onStartRefresh(com.shizhefei.mvc.IDataAdapter<DATA> adapter) {
		...
		@Override
		public void onEndRefresh(com.shizhefei.mvc.IDataAdapter<DATA> adapter, DATA result) {
			if (onStateChangeListener != null) {
		...
		@Override
		public void onStartLoadMore(com.shizhefei.mvc.IDataAdapter<DATA> adapter) {
			if (onStateChangeListener != null) {
		...
		@Override
		public void onEndLoadMore(com.shizhefei.mvc.IDataAdapter<DATA> adapter, DATA result) {
			if (onStateChangeListener != null) {
