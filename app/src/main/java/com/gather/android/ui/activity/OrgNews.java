...
import com.gather.android.adapter.OrgNewsListAdapter;
import com.gather.android.adapter.data.OrgNewsListData;
 ...
 */
public class OrgNews extends BaseActivity {
    ...
    private MVCHelper<List<OrgNewsEntity>> listViewHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.org_news);
        ...
        if (intent.hasExtra("ID")) {
            ...
            listViewHelper = new MVCUltraHelper<List<OrgNewsEntity>>(ptrLayout);
            listViewHelper.setDataSource(new OrgNewsListData(orgId));
            listViewHelper.setAdapter(new OrgNewsListAdapter(this, orgName, orgLogo));
