...
public final class InactivityTimer {
	...
	public synchronized void onActivity() {
		cancel();
		inactivityTask = new InactivityAsyncTask<Object, Object, Object>();
//		inactivityTask.execute();
	 ...
	 */
	private final class InactivityAsyncTask<Object, Integer, DATA> extends
			AsyncTask<Object, Integer, DATA> {
		@Override
