...
final class AutoFocusManager implements Camera.AutoFocusCallback {
	...
	public synchronized void onAutoFocus(boolean success, Camera theCamera) {
		if (active) {
			outstandingTask = new AutoFocusTask<Object, Object, Object>();
//			outstandingTask.execute();
	...
	private final class AutoFocusTask<Object, Integer, DATA> extends AsyncTask<Object, Integer, DATA> {
		@Override
		protected DATA doInBackground(Object... voids) {
			try {
