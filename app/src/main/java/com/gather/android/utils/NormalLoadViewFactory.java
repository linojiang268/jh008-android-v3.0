...
/**
 * Created by Christain on 2015/5/27.
 */
public class NormalLoadViewFactory implements ILoadViewFactory {
    ...
    private class LoadMoreHelper implements ILoadMoreView {
        ...
        public void init(FootViewAdder footViewHolder, View.OnClickListener onClickRefreshListener) {
            footView = (TextView) footViewHolder.addFootView(R.layout.loadmore_footer);
...
//            loadingview.setLoadingText("加载中...");
        ...
        @Override
        public void showFail() {
            View layout = helper.inflate(com.shizhefei.view.mvc.R.layout.load_error);
...
//            button.setOnClickListener(onClickRefreshListener);
        ...
        public void showEmpty() {
            View layout = helper.inflate(com.shizhefei.view.mvc.R.layout.load_empty);
            TextView textView = (TextView) layout.findViewById(com.shizhefei.view.mvc.R.id.textView1);
