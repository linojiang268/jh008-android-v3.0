...
public class FolderAdapter extends BaseAdapter {
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    ImageRequest request = ImageRequestBuilder.newBuilderWithSource(Uri.parse("file://" + f.cover.path))
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            // 显示图片
            ImageRequest request = ImageRequestBuilder.newBuilderWithSource(Uri.parse("file://" + data.cover.path))
                    .setResizeOptions(new ResizeOptions(200, 200))
                    .build();
            DraweeController controller = Fresco.newDraweeControllerBuilder()
